...
import "./servicesPageCardHover.css";
...
export default function ServicesPageCardHover({ hoverImage, projects }) {
...
ServicesPageCardHover.propTypes = {
  hoverImage: PropTypes.any,
